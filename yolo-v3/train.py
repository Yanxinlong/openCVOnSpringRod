...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data_v2/data.data', help='*.data path')
    parser.add_argument('--multi-scale', action='store_true', help='adjust (67%% - 150%%) img_size every 10 batches')
    parser.add_argument('--img-size', nargs='+', type=int, default= [512,512], help='[min_train, max-train, test]')
